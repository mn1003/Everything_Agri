        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Everything Agri</h1>
              <p class="text-white">
                ...
                <div class="card card-body bg-gradient-success">
                  <blockquote cite="blockquote">
                    <h6 class="mb-0 text-dark">
                      <em><b  id="quote"> “The farmer is the only man in our economy who buys everything at retail, sells everything at wholesale, and pays the freight both ways.”</b ></em>
                    </h6>
                    <br />
...
const apiKey = "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";   // Enter your apikey here
